% ----------===== MINI PUTT =====---------
% Matthew Fenwick & Christian Gallai
% June 20th, 2005
...
procedure Draw_Opening_Menu
    ...
    Draw.Text ("By: Matthew Fenwick And Christian Gallai", 210, 445, FontID (4), black)
...
proc Opening_Animation
    ...
    for horiz : 1 .. 120
	Draw.Text ("By: Matthew Fenwick", -60 + horiz, 50, FontID (8), white)
	Draw.Text ("& Christian Gallai", maxy - horiz, 50, FontID (8), white)
	View.Update
	exit when horiz = 100
	Pic.Draw (Line_Clear, 0, 0, picCopy)
    end for
